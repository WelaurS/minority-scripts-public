...
declare interface ScriptDescription {
	...
	OnKeyEvent?: (event: KeyEventObject) => boolean | void;
...
interface WardTracker
{
	GetWardList(): Readonly<WardInfo[]>;
}

declare function GetGlobal(): Global;
...
declare class LinearProjectileObject {
	index: number;
	currentPosition: Vector;
...
declare class EntitySystem {
	static GetByIndex(index: number): Entity;
...
declare class Renderer {
	...
	static LoadFont(name: string, size: number, weight: Enum.FontWeight, flags?: Enum.FontFlags): Font;
	...
	static SetDrawColor(r: number, g: number, b: number, a: number, time?: number): void;
	 ...
	 */
	static DrawText(font: Font, x: number, y: number, text: string, time?: number, align?: Enum.ContentAlign): void;

	/**
	 * @param align Enum.ContentAlign.LeftBottom
	 */
	static DrawImage(imageHandle: LoadedImage, x: number, y: number, width: number, height: number, time?: number, align?: Enum.ContentAlign): void;

	/**
	 * @param align Enum.ContentAlign.LeftBottom
	 */
	static DrawFilledRect(x: number, y: number, width: number, height: number, time?: number, align?: Enum.ContentAlign): void;

	/**
	 * @param align Enum.ContentAlign.LeftBottom
	 */
	static DrawOutlineRect(x: number, y: number, width: number, height: number, time?: number, align?: Enum.ContentAlign): void;

	/**
	 * @param align Enum.ContentAlign.LeftBottom
	 */
	static DrawWorldImage(id: LoadedImage, vec1: Vector, w: number, h: number, time?: number, align?: Enum.ContentAlign, xOffset?: number, yOffset?: number): void;

	/**
	 * @param align Enum.ContentAlign.LeftBottom
	 */
	static DrawWorldFilledRect(vec: Vector, w: number, h: number, time?: number, align?: Enum.ContentAlign, xOffset?: number, yOffset?: number): void;

	/**
	 * @param align Enum.ContentAlign.LeftBottom
	 */
	static DrawWorldOutlineRect(vec: Vector, w: number, h: number, time?: number, align?: Enum.ContentAlign, xOffset?: number, yOffset?: number): void;

	/**
	 * @param align Enum.ContentAlign.LeftBottom
	 */
	static DrawWorldText(font: Font, vec: Vector, text: string, time?: number, align?: Enum.ContentAlign, xOffset?: number, yOffset?: number): void;
	 ...
	 */
	static LoadImageModifier(fileName: string, debuffColor?: boolean): LoadedImage;

	/**
	 * @deprecated use DrawWorldImage
	 */
	...
	/**
	 * @deprecated use DrawWorldFilledRect
	 */
	...
	/**
	 * @deprecated use DrawWorldOutlineRect
	 */
	...
	/**
	 * @deprecated use DrawText
	 */
	static DrawTextCentered(font: Font, x: number, y: number, text: string, time?: number): void;

	/**
	 * @deprecated use Enum.FontFlags.OUTLINE flag in LoadFont
	 */
...
declare class NPC extends Entity {
	...
	SetGemColor(r: number, g: number, b: number, a: number): void;
...
declare class Engine {
	...
	static GetProfile(): ProtobufLiteObject;

	static IsRequestDone(): boolean;

	static RequestProfile(steamID32: number): void;

	static IsSearchMatch(): boolean;

	static IsDevMode(): boolean;

	static GetCompetitiveMMR(): number;
	 ...
	 * */
	static OnceAtByKey(time: number, key: string, realTime?: boolean): boolean;
...
declare namespace Enum {
	...
	export enum ElementType {
		...
		ELEMENT_TYPE_MULTI_SELECT,
		ELEMENT_TYPE_KEYBIND,
		ELEMENT_TYPE_INPUTBOX,
		ELEMENT_TYPE_BUTTON,
		ELEMENT_TYPE_COLOR_PICKER,
		ELEMENT_TYPE_SKIP_LINE,
		ELEMENT_TYPE_COLOR_PICKER_BLOCK,
		ELEMENT_TYPE_LABEL,
		ELEMENT_TYPE_PRIORITY_SELECT
	}
...
declare class Humanizer {
	static CalculateTimeForOrder(pos?: Vector): number;

	static GetRandom(): number;

	static SetMaxCursorTime(val: number): void;

	static GetMaxCursorTime(): number;

	static SetBaseCursorTime(val: number): void;

	static GetBaseCursorTime(): number;

	static SetReturnTime(val: number): void;

	static GetReturnTime(): number;

	static SetLingerTime(val: number): void;

	static GetLingerTime(): number;

	static SetRandomAddTime(val: number): void;

	static GetRandomAddTime(): number;
...
declare class MenuToggleHandler extends MenuOptionHandler {
	...
	SetValue(value: boolean, callback?: boolean): this;
...
declare class Menu {
	static GetFolderOptions(whereAt: Array<string>): Array<MenuOptionHandler>;

	static GetFolder(whereAt: Array<string>): MenuOptionHandler;

	static AddButton(whereAt: Array<string>, name: string, callback: () => void): MenuOptionHandler;
	...
	static IsKeyDown(handle: MenuKeyBindHandler, checkInputCapture?: boolean): boolean;

	static IsKeyDownOnce(handle: MenuKeyBindHandler, checkInputCapture?: boolean): boolean;
...
declare class Matchmaking {
	...
	static AcceptParty(groupID: BigInt): void;

	static GetLaneSelectionFlags(): number;

	static SetLaneSelectionFlags(val: number): void;

	static GetGameModes(): number;
	...
	static GetPartyData(): any;

	static GetLobbyData(): any;

	static StopFindingMatch(): void;

	static FindMatch(type: number): void;
}
...
declare class HTTP {
	static Request(url: string, path: string, method: string, optInfo?: HTTPRequestInfo): HTTPConnection;
}
